...
idleoffsets = {'0', '-240'} -- I recommend you have your idle offset at 0
rightoffsets = {'-6', '-239'}
downoffsets = {'-5', '-241'}
upoffsets = {'-2', '-235'}
leftoffsets = {'-5', '-243'}
...
idle_xml_name = 'BGF IdleNormal'
right_xml_name = 'BGF Note RIGHTNormal'
down_xml_name = 'BGF Note DOWNNormal'
up_xml_name = 'BGF Note UPNormal'
left_xml_name = 'BGF Note LEFTNormal'
...
name_of_character_xml = 'gf-6-1'
name_of_character = 'gf-6-1'
name_of_notetype = 'gf-6-1'
