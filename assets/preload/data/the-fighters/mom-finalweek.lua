...
idleoffsets = {'-50', '60'} -- I recommend you have your idle offset at 0
rightoffsets = {'-109', '34'}
downoffsets = {'-30', '-110'}
upoffsets = {'-62', '129'}
leftoffsets = {'191', '2'}
...
idle_xml_name = 'Mom Idle'
right_xml_name = 'Mom Left Pose'
down_xml_name = 'MOM DOWN POSE'
up_xml_name = 'Mom Up Pose'
left_xml_name = 'Mom Pose Left'
...
name_of_character_xml = 'mom-finalweek'
name_of_character = 'mom-finalweek'
name_of_notetype = 'mom-finalweek'
